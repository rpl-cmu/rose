...
class tqdm {
  private:
    ...
    std::vector<const char *> bars = {" ", "â–", "â–Ž", "â–", "â–Œ", "â–‹", "â–Š", "â–‰", "â–ˆ"};
  ...
  public:
    ...
    void set_theme_line() { bars = {"â”€", "â”€", "â”€", "â•¾", "â•¾", "â•¾", "â•¾", "â”", "â•"}; }
    void set_theme_circle() { bars = {" ", "â—“", "â—‘", "â—’", "â—", "â—“", "â—‘", "â—’", "#"}; }
    void set_theme_braille() { bars = {" ", "â¡€", "â¡„", "â¡†", "â¡‡", "â¡", "â¡Ÿ", "â¡¿", "â£¿"}; }
    void set_theme_braille_spin() { bars = {" ", "â ™", "â ¹", "â ¸", "â ¼", "â ´", "â ¦", "â ‡", "â ¿"}; }
    void set_theme_vertical() { bars = {"â–", "â–‚", "â–ƒ", "â–„", "â–…", "â–†", "â–‡", "â–ˆ", "â–ˆ"}; }
