...
inline gtsam::NonlinearFactor::shared_ptr parsePlanarPriorFactor(const nlohmann::json &input_json) {
...
inline nlohmann::json serializePlanarPriorFactor(gtsam::NonlinearFactor::shared_ptr factor) {
